...
namespace CABDevExpress.Workspaces
{
    ...
    /// </summary>
    public class RibbonWindowWorkspace : Workspace<Control, RibbonWindowSmartPartInfo>
    {
        private readonly Dictionary<Control, RibbonForm> windowDictionary = new Dictionary<Control, RibbonForm>();
        ...
        public RibbonWindowWorkspace(IWin32Window ownerForm)
        {
        ...
        /// </summary>
        [Browsable(false)]
        public ReadOnlyDictionary<Control, RibbonForm> Windows
        {
            get { return new ReadOnlyDictionary<Control, RibbonForm>(windowDictionary); }
        }
        ...
        /// </summary>
        protected static void SetWindowLocation(Form form, RibbonWindowSmartPartInfo info)
        {
        ...
        /// WindowForm class
        /// </summary>
        private class RibbonWindowForm : RibbonForm
        {
            /// <summary>
