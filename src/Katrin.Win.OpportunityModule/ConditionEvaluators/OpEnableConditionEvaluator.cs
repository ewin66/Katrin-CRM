...
namespace Katrin.Win.OpportunityModule
{
	...
	public class OpEnableConditionEvaluator: IConditionEvaluator
	{
        /// <summary>
        /// check the command won,fail,recyle enable
        /// </summary>
		...
		{
            if (!(caller is OpportunityDetailController)) return false;
