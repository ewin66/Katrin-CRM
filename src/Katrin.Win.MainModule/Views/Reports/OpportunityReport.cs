...
namespace Katrin.Win.MainModule.Views.Reports
{
    public partial class OpportunityReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void OnNameCellClicked(DataEventArgs<OpportunityOverview> e)
        {
            EventHandler<DataEventArgs<OpportunityOverview>> handler = NameCellClicked;
        ...
        void projectNameCell_PreviewClick(object sender, PreviewMouseEventArgs e)
        {
            ...
            OnNameCellClicked(new DataEventArgs<OpportunityOverview>(overviewItem));
        }
