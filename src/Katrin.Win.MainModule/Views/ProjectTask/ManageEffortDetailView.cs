...
{
    [SmartPart]
    public partial class ManageEffortDetailView : AbstractDetailView, IManageEffortDetailView
    {
        private ManageEffortDetailPresenter _presenter;
        public event EventHandler OnCreateData;
        public event EventHandler<EventArgs<int>> OnDeleteData;

        [CreateNew]
        public ManageEffortDetailPresenter Presenter
        {
            set
            {
                _presenter = value;
