...
namespace Katrin.Win.Common.CustomerFunctions
{
    public class IsPriorDaysFunction : ICustomFunctionOperatorBrowsable
    {
        private const string FunctionName = "IsPriorDays";
        private static readonly IsPriorDaysFunction instance = new IsPriorDaysFunction();
