...
namespace ICSharpCode.Core
{
	...
	public static class AddInTree
	{
        ...
        /// <summary>
        /// Builds the items in the path for dictionary format. Ensures that all items have the type T. 
        /// add by hecq 2012-10-23
        /// </summary>
        ...
        public static Dictionary<string,T> BuildDictionaryItems<T>(string path, object caller, bool throwOnNotFound)
        {
            ...
            if (node == null)
                ...
                return node.BuildDictionaryChildItems<T>(caller);
        }
