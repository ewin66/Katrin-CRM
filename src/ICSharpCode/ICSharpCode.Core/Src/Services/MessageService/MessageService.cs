...
namespace ICSharpCode.Core
{
	...
	public static class MessageService
	{
        ...
        public static DialogResult AskQuestionYesNoCancel(string question, string caption)
        {
            return ServiceManager.Instance.MessageService.AskQuestionYesNoCancel(question, caption);
        }
