...
namespace Katrin.Win.QuoteModule
{
    ...
    public partial class QuoteDetailView : DetailView, IQuoteDetailView
    {
        ...
        private void quoteLineItemGridView_ShownEditor(object sender, EventArgs e)
        {
            var editor = quoteLineItemGridView.ActiveEditor;
            if (!(editor is SpinEdit)) return;

            ((SpinEdit)editor).ImeMode = ImeMode.Disable;
        }
